...
var DeliveryClient = /** @class */ (function () {
     ...
     */
    DeliveryClient.prototype.languages = function () {
...
__exportStar(__webpack_require__(/*! ./language-contracts */ "./lib/data-contracts/language-contracts.ts"), exports);
...
/***/ "./lib/data-contracts/language-contracts.ts":
/*!**************************************************!*\
  !*** ./lib/data-contracts/language-contracts.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
var models_1 = __webpack_require__(/*! ../models */ "./lib/models/index.ts");
var LanguageMapper = /** @class */ (function () {
    function LanguageMapper() {
    }
    LanguageMapper.prototype.mapMultipleLanguages = function (response) {
        var _this = this;
        return response.languages.map(function (language) {
            return _this.mapLanguage(language);
        });
    };
    LanguageMapper.prototype.mapLanguage = function (language) {
        if (!language) {
...
__exportStar(__webpack_require__(/*! ./language */ "./lib/models/language/index.ts"), exports);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./language-models */ "./lib/models/language/language-models.ts"), exports);
__exportStar(__webpack_require__(/*! ./responses */ "./lib/models/language/responses.ts"), exports);


/***/ }),

/***/ "./lib/models/language/language-models.ts":
/*!************************************************!*\
  !*** ./lib/models/language/language-models.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./lib/models/language/responses.ts":
/*!******************************************!*\
  !*** ./lib/models/language/responses.ts ***!
  \******************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var models_1 = __webpack_require__(/*! ../../models */ "./lib/models/index.ts");
var parse_models_1 = __webpack_require__(/*! ../parse-models */ "./lib/parser/parse-models.ts");
...
var BrowserRichTextParser = /** @class */ (function () {
    ...
    BrowserRichTextParser.prototype.resolveRichTextElement = function (contentItemCodename, html, elementName, replacement, config, linkedItemIndex) {
    ...
    BrowserRichTextParser.prototype.processRichTextElement = function (contentItemCodename, elementName, htmlCollection, replacement, config, result, linkedItemIndex) {
            ...
            for (var i = 0; i < htmlCollection.length; i++) {
                ...
                if (element.nodeName.toLowerCase() === parser_configuration_1.parserConfiguration.linkElementData.nodeName.toLowerCase()) {
                    ...
                    if (dataItemIdAttribute) {
                        ...
                        var urlSlugResult = replacement.getUrlSlugResult(linkObject.dataItemId, linkText);
 ...
 */
var RichTextItemIndexReferenceWrapper = /** @class */ (function () {
    function RichTextItemIndexReferenceWrapper(index) {
        this.index = index;
    }
    RichTextItemIndexReferenceWrapper.prototype.increment = function () {
        this.index++;
    };
    return RichTextItemIndexReferenceWrapper;
}());
...
__exportStar(__webpack_require__(/*! ./language/base-language-query.class */ "./lib/query/language/base-language-query.class.ts"), exports);
...
/***/ "./lib/query/language/base-language-query.class.ts":
/*!*********************************************************!*\
  !*** ./lib/query/language/base-language-query.class.ts ***!
  \*********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var models_1 = __webpack_require__(/*! ../../models */ "./lib/models/index.ts");
var base_language_query_class_1 = __webpack_require__(/*! ./base-language-query.class */ "./lib/query/language/base-language-query.class.ts");
